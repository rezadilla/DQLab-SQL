...
-- Tampilan Daftar Produk yang memiliki Harga antara 50.000 dan 150.000 mengacu pada table ms_produk
SELECT
    no_urut,
    kode_produk,
    nama_produk,
...
-- Tampilan semua produk yang mengandung kata Flashdisk
SELECT
	no_urut,
	kode_produk,
	nama_produk,
...
-- 	Tampilan nama pelanggan yang memiliki gelar : S.H, Ir. dan Drs.
SELECT
    no_urut,
    kode_pelanggan,
    nama_pelanggan,
...
-- Tampilan nama pelanggan berdasarkan kolom nama_pelanggan dari yang terkecil ke yang terbesar (A ke Z)
SELECT
    nama_pelanggan
FROM
    ms_pelanggan
...
-- Tampilan nama_pelanggan dari terkecil ke terbesar (A ke Z) tanpa gelar
SELECT
    nama_pelanggan
FROM
    ms_pelanggan
...
-- Tampilan nama_pelanggan yang memiliki nama paling panjang. Jika lebih dari 1 orang yang memiliki panjang nama yang sama, tampilkan semuanya
SELECT
    nama_pelanggan
FROM
    ms_pelanggan
...
-- Tampilan Naman Pelanggan yang paling panjang dengan gelar
SELECT
    nama_pelanggan
FROM
    ms_pelanggan
...
-- Tampilan Produk yang paling banyak terjual dari segi kuantitas. Jika ada lebih dari 1 produk dengan nilai yang sama, tampilkan semua produk 
SELECT
